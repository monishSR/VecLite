...
func createTempFile(t *testing.T) string {
	tmpFile, err := os.CreateTemp("", "veclite_ivf_test_*.db")
	if err != nil {
...
func createTestIVF(t *testing.T) (*IVFIndex, func()) {
...
func TestIVFIndex_Insert_FirstVector(t *testing.T) {
	...
	if len(index.centroids) != 1 {
		t.Errorf("Expected 1 centroid after first insert, got %d", len(index.centroids))
	}
}

func TestIVFIndex_Insert_Multiple(t *testing.T) {
	index, cleanup := createTestIVF(t)
	defer cleanup()
	...
	// First vector becomes first centroid, next 9 become centroids (up to nClusters=10)
	if len(index.centroids) != 10 {
		t.Errorf("Expected 10 centroids, got %d", len(index.centroids))
	}
}

func TestIVFIndex_Insert_DimensionMismatch(t *testing.T) {
	index, cleanup := createTestIVF(t)
	defer cleanup()
...
func TestIVFIndex_Insert_UpdateExisting(t *testing.T) {
	index, cleanup := createTestIVF(t)
	defer cleanup()
	...
	// Delete the vector first (to simulate update)
	if err := index.Delete(1); err != nil {
		t.Fatalf("Failed to delete: %v", err)
	}

	// Insert with same ID (update)
...
func TestIVFIndex_Insert_NoStorage(t *testing.T) {
	config := make(map[string]any)
	...
	err = index.Insert(1, vector)
	if err == nil {
		t.Error("Expected error when inserting without storage")
	}
}

func TestIVFIndex_Search_EmptyIndex(t *testing.T) {
	index, cleanup := createTestIVF(t)
	defer cleanup()
...
func TestIVFIndex_Search_Basic(t *testing.T) {
	index, cleanup := createTestIVF(t)
	defer cleanup()
...
func TestIVFIndex_Search_DifferentK(t *testing.T) {
	index, cleanup := createTestIVF(t)
	defer cleanup()

	// Insert 20 vectors (more than nClusters=10 to ensure we have vectors in clusters)
	...
	if len(results3) < 1 {
		t.Errorf("Expected at least 1 result, got %d", len(results3))
	}
	if len(results3) > 3 {
		t.Errorf("Expected at most 3 results, got %d", len(results3))
	}
...
func TestIVFIndex_Search_DimensionMismatch(t *testing.T) {
	index, cleanup := createTestIVF(t)
	defer cleanup()
...
func TestIVFIndex_Search_InvalidK(t *testing.T) {
	index, cleanup := createTestIVF(t)
	defer cleanup()
...
func TestIVFIndex_Search_NoStorage(t *testing.T) {
	config := make(map[string]any)
	index, err := NewIVFIndex(128, config, nil)
	if err != nil {
		t.Fatalf("Failed to create IVF index: %v", err)
	...
	if err == nil {
		t.Error("Expected error when searching without storage")
	}
}

func TestIVFIndex_ReadVector(t *testing.T) {
	index, cleanup := createTestIVF(t)
	defer cleanup()
...
func TestIVFIndex_ReadVector_NotFound(t *testing.T) {
	index, cleanup := createTestIVF(t)
	defer cleanup()
...
func TestIVFIndex_ReadVector_NoStorage(t *testing.T) {
	config := make(map[string]any)
	index, err := NewIVFIndex(128, config, nil)
	if err != nil {
		t.Fatalf("Failed to create IVF index: %v", err)
	...
	if err == nil {
		t.Error("Expected error when reading without storage")
	}
}

func TestIVFIndex_Size(t *testing.T) {
	index, cleanup := createTestIVF(t)
	defer cleanup()
...
func TestIVFIndex_Delete_NonExistent(t *testing.T) {
	index, cleanup := createTestIVF(t)
	defer cleanup()
...
func TestIVFIndex_Delete_NoStorage(t *testing.T) {
	config := make(map[string]any)
	index, err := NewIVFIndex(128, config, nil)
	if err != nil {
		t.Fatalf("Failed to create IVF index: %v", err)
...
func TestIVFIndex_Clear(t *testing.T) {
	index, cleanup := createTestIVF(t)
	defer cleanup()
	...
	if len(index.centroids) != 0 {
		t.Errorf("Expected 0 centroids after clear, got %d", len(index.centroids))
	}

	if len(index.clusters) != 0 {
		t.Errorf("Expected 0 clusters after clear, got %d", len(index.clusters))
	}
}

func TestIVFIndex_Clear_NoStorage(t *testing.T) {
	config := make(map[string]any)
	index, err := NewIVFIndex(128, config, nil)
	if err != nil {
		t.Fatalf("Failed to create IVF index: %v", err)
...
func TestIVFIndex_MultipleClusters(t *testing.T) {
	index, cleanup := createTestIVF(t)
	defer cleanup()
...
func TestIVFIndex_NewIVFIndex_InvalidDimension(t *testing.T) {
	config := make(map[string]any)
	_, err := NewIVFIndex(0, config, nil)
	if err == nil {
		t.Error("Expected error for dimension 0")
	}

	_, err = NewIVFIndex(-1, config, nil)
	if err == nil {
		t.Error("Expected error for negative dimension")
	}
}

func TestIVFIndex_NewIVFIndex_WithConfig(t *testing.T) {
	tmpFile := createTempFile(t)
	...
	if index.nClusters != 20 {
		t.Errorf("Expected nClusters 20, got %d", index.nClusters)
	}
